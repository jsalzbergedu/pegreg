...
\begin{alignat}{2}& \notag
 \mathit{PEGREG} : \mathit{PEG} \to \mathit{REG} \to \mathit{REG} \\&
 \mathit{PEGREG}(c, r)  =  c.r \\&
 \mathit{PEGREG}(P1.P2, r)  =  \mathit{PEGREG}(P1, \mathit{PEGREG}(P2, r)) \\&
 \mathit{PEGREG}(P1/P2, r)  =  \mathit{PEGREG}(P1, r) \cup
  (\mathit{PEGREG(P2, r)} \cap \neg\mathit{PEGREG}(P1, \varepsilon))\\&
 \mathit{PEGREG}(P1*, r)  =  \mathit{PEGREG}(P1, \varepsilon)*.
  (r \cap \neg\mathit{PEGREG}(P1, \varepsilon))
\end{alignat}
